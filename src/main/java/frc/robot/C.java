...
public final class C {
  ...
  public static final class Drivestyle {
    // Drive Style definition, loop up. Don't change this! This is needed for
    // the subsystem.
    ...
    // Tuning the Chezy Drive - deadband, sensitivity & tolerancing values on
    // raw joystick inputs
    ...
    public static final double sensitivityLow =
        0.5; // (**deafult uses low gear**)

    public static final double wheelNonLinearityHighGear =
        0.5; // Chezy Drive non-linearity
    public static final double wheelNonLinearityLowGear =
        0.6; // Chezy Drive non-linearity  (**deafult uses low gear**)

    public static final double QuickTurnSensitivityHigh =
        0.005; // Chezy Drive quick turn sensitivity
    public static final double QuickTurnSensitivityLow =
        0.005; // Chezy Drive quick turn sensitivity  (**deafult uses low
               // gear**)
  }
  ...
  public static final class Drive {
    ...
    public static final Gains turnGains =
        new Gains(0.018275, 0, 0.00175, 0, 0, 0.025, 0.1, 0.1);
    ...
    public static final Gains distanceGains =
        new Gains(0.040, 0.0001, 1, 0, 2, 2, 0.1, 0.1);
  ...
  public static final class Superstructure {
    ...
    public static final double offset_incrment_constant =
        0.06; // 1 deg a second

    public static final double testMove = 0.03;
    public static final double shoulderAccelerationLimitv5 =
        5000; // native sensor units per 100 ms per ms
    public static final double elbowAccelerationLimitv5 =
        5000000; // native sensor units per 100 ms per ms
    public static final double shoulderVelocityLimitv5 =
        5000; // native sensor units per 100ms, 1k is approx 10%
    public static final double elbowVelocityLimitv5 = 50000000;
    public static final int shoulderSCurveStrengthv5 =
        0; // zero is trapizodal motion profiling.
    public static final int elbowSCurveStrengthv5 =
        0; //  zero is trapizodal motion profiling.
