...
public class Superstructure extends SubsystemBase {
  ...
  private final TalonFX shoulderMotor_starboard =
      new TalonFX(C.CANid.shoulderMotor_Starboard);
  private final TalonFX shoulderMotor_port =
      new TalonFX(C.CANid.shoulderMotor_Port);
  ...
  DigitalInput ElbowIndexSensor =
      new DigitalInput(C.Superstructure.Elbow_Index_Channel);
  DigitalInput ShoulderIndexSensor =
      new DigitalInput(C.Superstructure.Shoulder_Index_Channel);
  ...
  enum GamePiece { Cone, Cube, Empty }
  ...
  public Superstructure() {
    ...
    shoulderMotor_starboard.configSupplyCurrentLimit(
        new SupplyCurrentLimitConfiguration(true, 40, 0, 0));
    shoulderMotor_port.configSupplyCurrentLimit(
        new SupplyCurrentLimitConfiguration(true, 40, 0, 0));
    elbowMotor.configSupplyCurrentLimit(
        new SupplyCurrentLimitConfiguration(true, 40, 0, 0));
    ...
    elbowMotor.configNominalOutputForward(C.Superstructure.elbow_maxOutput,
                                          C.Superstructure.kTimeoutMs);
    elbowMotor.configNominalOutputReverse(C.Superstructure.elbow_minOutput,
                                          C.Superstructure.kTimeoutMs);
    elbowMotor.configPeakOutputForward(C.Superstructure.elbow_maxOutput,
                                       C.Superstructure.kTimeoutMs);
    elbowMotor.configPeakOutputReverse(C.Superstructure.elbow_minOutput,
                                       C.Superstructure.kTimeoutMs);

    shoulderMotor_starboard.configNominalOutputForward(
        C.Superstructure.shoulder_maxOutput, C.Superstructure.kTimeoutMs);
    shoulderMotor_starboard.configNominalOutputReverse(
        C.Superstructure.shoulder_minOutput, C.Superstructure.kTimeoutMs);
    shoulderMotor_starboard.configPeakOutputForward(
        C.Superstructure.shoulder_maxOutput, C.Superstructure.kTimeoutMs);
    shoulderMotor_starboard.configPeakOutputReverse(
        C.Superstructure.shoulder_minOutput, C.Superstructure.kTimeoutMs);

    shoulderMotor_port.configNominalOutputForward(
        C.Superstructure.shoulder_maxOutput, C.Superstructure.kTimeoutMs);
    shoulderMotor_port.configNominalOutputReverse(
        C.Superstructure.shoulder_minOutput, C.Superstructure.kTimeoutMs);
    shoulderMotor_port.configPeakOutputForward(
        C.Superstructure.shoulder_maxOutput, C.Superstructure.kTimeoutMs);
    shoulderMotor_port.configPeakOutputReverse(
        C.Superstructure.shoulder_minOutput, C.Superstructure.kTimeoutMs);

    /* Config the sensor used for Primary PID and sensor direction */
    shoulderMotor_starboard.configSelectedFeedbackSensor(
        TalonFXFeedbackDevice.IntegratedSensor, C.Superstructure.kPIDLoopIdx,
        C.Superstructure.kTimeoutMs);
    elbowMotor.configSelectedFeedbackSensor(
        TalonFXFeedbackDevice.IntegratedSensor, C.Superstructure.kPIDLoopIdx,
        C.Superstructure.kTimeoutMs);
    ...
    shoulderMotor_starboard.config_kF(C.Superstructure.kPIDLoopIdx,
                                      C.Superstructure.shoulder_kff,
                                      C.Superstructure.kTimeoutMs);
    shoulderMotor_starboard.config_kP(C.Superstructure.kPIDLoopIdx,
                                      C.Superstructure.shoulder_kp,
                                      C.Superstructure.kTimeoutMs);
    shoulderMotor_starboard.config_kI(C.Superstructure.kPIDLoopIdx,
                                      C.Superstructure.shoulder_ki,
                                      C.Superstructure.kTimeoutMs);
    shoulderMotor_starboard.config_kD(C.Superstructure.kPIDLoopIdx,
                                      C.Superstructure.shoulder_kd,
                                      C.Superstructure.kTimeoutMs);
    shoulderMotor_starboard.config_IntegralZone(C.Superstructure.kPIDLoopIdx,
                                                C.Superstructure.shoulder_kIz,
                                                C.Superstructure.kTimeoutMs);

    elbowMotor.config_kF(C.Superstructure.kPIDLoopIdx,
                         C.Superstructure.elbow_kff,
                         C.Superstructure.kTimeoutMs);
    elbowMotor.config_kP(C.Superstructure.kPIDLoopIdx,
                         C.Superstructure.elbow_kp,
                         C.Superstructure.kTimeoutMs);
    elbowMotor.config_kI(C.Superstructure.kPIDLoopIdx,
                         C.Superstructure.elbow_ki,
                         C.Superstructure.kTimeoutMs);
    elbowMotor.config_kD(C.Superstructure.kPIDLoopIdx,
                         C.Superstructure.elbow_kd,
                         C.Superstructure.kTimeoutMs);
    elbowMotor.config_IntegralZone(C.Superstructure.kPIDLoopIdx,
                                   C.Superstructure.elbow_kIz,
                                   C.Superstructure.kTimeoutMs);

    /* Set acceleration and vcruise velocity - see documentation */
    /*shoulderMotor_starboard.configMotionCruiseVelocity(15000,
    Constants.kTimeoutMs); shoulderMotor_port.configMotionAcceleration(6000,
    ...
    /* Set up motion Magic */
    shoulderMotor_starboard.configMotionAcceleration(
        C.Superstructure.shoulderAccelerationLimitv5);
    elbowMotor.configMotionAcceleration(
        C.Superstructure.elbowAccelerationLimitv5);
    shoulderMotor_starboard.configMotionCruiseVelocity(
        C.Superstructure.shoulderVelocityLimitv5);
    elbowMotor.configMotionCruiseVelocity(
        C.Superstructure.elbowVelocityLimitv5);

    // Set to zero if you want trapezoidal motion during motion magic.
    shoulderMotor_starboard.configMotionSCurveStrength(
        C.Superstructure.shoulderSCurveStrengthv5);
    elbowMotor.configMotionSCurveStrength(
        C.Superstructure.elbowSCurveStrengthv5);
  ...
  public void toggleIntakeIn() { // pickup cone
    ...
    if (IntakeMotor.getMotorOutputPercent() == 0) {
      IntakeMotor.set(ControlMode.PercentOutput,
                      C.Superstructure.IntakeMotorTalonPercentPower);
    } else {
  ...
  public double countsToAngle(double counts, double gearRatio) {
    /* test */
    return counts * gearRatio / C.Superstructure.countsPerRev *
        360.0; // flipped from angletocounts
  }
  ...
  public void setJointAngles(double[] angles) {
    shoulderMotor_starboard.set(
        ...
        angleToCounts(angles[0] + offset_angle[0],
                      C.Superstructure.shoulderGearRatio));
    elbowMotor.set(TalonFXControlMode.Position,
                   angleToCounts(angles[1] + offset_angle[1],
                                 C.Superstructure.elbowGearRatio));
  }
  ...
  public boolean isShoulderAtPosition(double angle) {
    return (Math.abs(countsToAngle(
                         shoulderMotor_starboard.getSelectedSensorPosition(),
                         C.Superstructure.shoulderGearRatio) -
                     angle) <= Math.abs(C.Superstructure.shoulder_tolerance));
  }
  ...
  public boolean isElbowAtPosition(double angle) {
    return (Math.abs(countsToAngle(elbowMotor.getSelectedSensorPosition(),
                                   C.Superstructure.shoulderGearRatio) -
                     angle) <= Math.abs(C.Superstructure.elbow_tolerance));
  }
  ...
  public boolean isAtPosition(double[] angles) {
    SmartDashboard.putBoolean(
        ...
        isShoulderAtPosition(angles[0] + offset_angle[0]));
    SmartDashboard.putBoolean("elbow in Position?",
                              isElbowAtPosition(angles[1] + offset_angle[1]));
    return isShoulderAtPosition(angles[0]) & isElbowAtPosition(angles[1]);
  }

  /**
   * If the current draw on the motor exceed the threshold, then there is a game
   * piece It returns what game piece is in the intake based on toggle. Toggle
   * will be updated by the driver.
  ...
  public boolean getElbowIndexSensor() { return !ElbowIndexSensor.get(); }
  public boolean getShoulderIndexSensor() { return !ShoulderIndexSensor.get(); }
  /*********************************************************************************************************************************************************
   */
  @Override
  public void periodic() {
    ...
    case Manual
      ...
      if (isAtPosition(C.Superstructure.StateMachinePositions.Home)) {
        ...
        if (offset_angle[0] != 0.0 | offset_angle[1] != 0.0) {
          armState = States.coDriverMode; coDriveCommand = States.coDriverMode;

        }

        // If codriver command has changed from home, lets go to the different
        // states.
        else if (coDriveCommand != States.Home) {
          // armState = States.ExtendOut;
          if (coDriveCommand == States.Ground) {
            armState = States.ExtendOut; setTimeOut(10000);
      ...
      resetElbowOffset(); resetShoulderOffset();
      ...
      if (isAtPosition(C.Superstructure.StateMachinePositions.ExtendIn)) {
        armState = States.Home; coDriveCommand = States.Home;
      }
    ...
    case Ground
      ...
      thresh = IntakeMotor.getMotorOutputPercent() > 0
                   ? C.Superstructure.IntakeConeCThresh
                   :
      C.Superstructure.IntakeCubeCThresh;
  ...
  /* SmartDashboard.putNumber("Shouldmotor.DNG",
  shoulderMotor_starboard.getSelectedSensorPosition());
  SmartDashboard.putNumber("Elbowmotor.DNG",
  elbowMotor.getSelectedSensorPosition());
  SmartDashboard.putNumber("ShoulderMotorOutput",
  shoulderMotor_starboard.getMotorOutputPercent());
  SmartDashboard.putNumber("ElbowMotorOutput",
  elbowMotor.getMotorOutputPercent()); SmartDashboard.putString("SuperStructure
  State", armState.name()); SmartDashboard.putNumber("shoulder Postion",
  countsToAngle(shoulderMotor_starboard.getSelectedSensorPosition(),
  C.Superstructure.shoulderGearRatio)); SmartDashboard.putNumber("elbow
  Postion", countsToAngle(elbowMotor.getSelectedSensorPosition(),
  C.Superstructure.elbowGearRatio));

  SmartDashboard.putString("CodriverCommand", coDriveCommand.toString());
  SmartDashboard.putNumber("Shoulder Velocity counts per 100ms",
  shoulderMotor_starboard.getSelectedSensorVelocity());
  SmartDashboard.putNumber("SHoulder following Veloctiy",
  shoulderMotor_port.getSelectedSensorVelocity());
  SmartDashboard.putNumber("Elbow Velocity counts per 100ms",
  elbowMotor.getSelectedSensorVelocity()); SmartDashboard.putBoolean("Sh_Index",
  getShoulderIndexSensor()); SmartDashboard.putBoolean("Elbow Index",
  getElbowIndexSensor()); */
}
/***************************************************************************************************************************************************************************
 */
/** return current state */
public States getCurrentState() { return armState; }

/** Sets the statemachine global timeout */
public void setTimeOut(double ms) { TimerCounter = (int)ms / 20; }
...
public boolean isTimedOut() { return expired; }
/** method for button to use as instant command to set the state to home  */
public void buttonHome() { coDriveCommand = States.ExtendIn; }
...
public void buttonMidScoreCube() { coDriveCommand = States.MidScoreCube; }
public void buttonTopScoreCube() { coDriveCommand = States.TopScoreCube; }
public void buttonTopScoreCone() { coDriveCommand = States.TopSCoreCone; }
public void buttonMidScoreCone() { coDriveCommand = States.MidScoreCone; }
/* funky manual code */
public void moveShoulderSlowUp() {
  shoulderMotor_starboard.set(ControlMode.PercentOutput,
                              C.Superstructure.testMove);
...
public void stopElbow() { elbowMotor.set(ControlMode.PercentOutput, 0); }
 ...
 */
public void resetShoulderOffset() { offset_angle[0] = 0.0; }
/**
 * resets offset at shoulder
 */
public void resetElbowOffset() { offset_angle[1] = 0.0; }
/**
 ...
 */
public void updatejointoffsets(double shoulder_joystick,
                               double elbow_joystick) {
